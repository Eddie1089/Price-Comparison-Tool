...
# Weights of products
product_1_weight_g = input("What is the weight of the {} in grams? ".format(product_1_name))
product_2_weight_g = input("What is the weight of the {} in grams? ".format(product_2_name))
product_3_weight_g = input("What is the weight of the {} in grams? ".format(product_3_name))
product_4_weight_g = input("What is the weight of the {} in grams? ".format(product_4_name))
product_5_weight_g = input("What is the weight of the {} in grams? ".format(product_5_name))
product_6_weight_g = input("What is the weight of the {} in grams? ".format(product_6_name))
